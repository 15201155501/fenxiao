					...
					<div class="L_querys">
						...
						<div class="L_querys_con">
							...
							<div class="L_querys_conm clearfix">
								<?php if(is_array($UserModel)): $i = 0; $__LIST__ = $UserModel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["hylocation"] == 1) AND $vo["hynumber"] != ''): ?><div class="L_querys_con1 fl">
										<?php if($vo["isapproved"] == 1): ?><form name="myForm" action="/index.php/Home/ManagementTeam/select"  method="post">
												<input type="hidden" name="ParentNumber" value="<?php echo ($vo["hynumber"]); ?>">
										<a href="javascript:document.myForm.submit();" ><h3>A点</h3>
											<p>
										...
										<div class="L_querys_con1 fl">
											<a href="/index.php/Home/ManagementTeam/Declaration/location/A">
											<h3>A点</h3>
											<p>空市场</p>
											</a>
										</div><?php endif; ?>

									<?php if($vo["hylocation"] == 2 AND $vo["hynumber"] != ''): ?><div class="L_querys_con1 L_querys_con2 fr">
											<?php if($vo["isapproved"] == 1): ?><form name="myForm" action="/index.php/Home/ManagementTeam/select"  method="post">
													<input type="hidden" name="ParentNumber" value="<?php echo ($vo["hynumber"]); ?>">
											<a href="javascript:document.myForm.submit();" ><h3>B点</h3>
												<p>
													编号:<span><?php echo ($vo["hynumber"]); ?></span>
												</p>
												<p>
										...
										<div class="L_querys_con1 L_querys_con2 fr">
											<a href="/index.php/Home/ManagementTeam/Declaration/location/B">
											<h3>B点</h3>
											<p>空市场</p>
											</a>
